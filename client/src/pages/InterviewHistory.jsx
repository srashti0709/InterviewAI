...
function InterviewHistory() {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-[#FDF4FF] py-10'>
        <div className='w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto'>
            ...
            <div className='grid gap-6 '>
                {interviews.map((item,index) => (
                    <div key = {index}
                    onClick={() => navigate(`/report/${item._id}`)} className='bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100'>
                        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                            <div>
                                ...
                                <p className='text-md text-gray-400 mt-2 font-bold'> {new Date(item.createdAt).toLocaleDateString() }</p>
                            </div>
